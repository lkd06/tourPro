...
function update(){
	...
	f.action="<%=cp %>/member/update_ok.km";
	f.submit();
}
function goMain(){
	var f = document.myForm;
		...
		<div class="special_content" align="center" style="width: 500; height: 1200px;">
			<div class="">
				<div class="" style="display: table; width: 33%;border: 0px solid; color: #c0c0c0;"  align="center">
					...
					<h2><b>정보수정</b></h2><br><br>
					<font size="4pt;"><b>
					아이디<br> ${dto.id }<br><br>
					패스워드<br> <input type="password" value="${dto.pw }" name="ch_pw" id="div1"/><br><br>
					이름<br> <input type="text" name="name" value="${dto.name }"  id="div1"/><br><br>
					주소<br> <input type="text" name="addr" value="${dto.addr }"  id="div1"/><br><br>
					TEL<br> <input type="text" name="tel" value="${dto.tel }"  id="div1"/><br><br>
					사용유형<br> 
					<select name="type" id="div1">
					 ...
					 E-MAIL<br> <input type="text" name="email" value="${dto.email }"  id="div1"/></b><br><br>
					</font> 
					</div>
				...
				<div class="" style="display: table; width: 20%; padding-rigth:20px; border: 0px solid; color: #c0c0c0;"  align="left">
				<div style="display: table-row;">
					<span style="display: table-cell;border: 0px solid;">
					<input type="button" value="정보수정" id="btn2" onclick="update();">
					</span>
