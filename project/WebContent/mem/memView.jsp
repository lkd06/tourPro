		...
		<div class="special_content" align="center" style="width: 500; height: 1200px;">
			<div class="">
				<div class="" style="display: table; width: 33%;border: 0px solid; color: #c0c0c0;"  align="center">
					...
					<h2><b>정보확인</b></h2><br><br>
					<font size="4pt;"><b>
					아이디<br> ${dto.id }<br><br>
					이름<br> ${dto.name }<br><br>
					주소<br> ${dto.addr }<br><br>
					TEL<br> ${dto.tel }<br><br>
					사용유형<br> ${dto.type }<br><br>
					 E-MAIL<br> ${dto.email }</b><br><br>
					</font> 
					</div>
