...
function upload(){
	...
	f.action="<%=cp %>/tourImages/write_ok.km";
	f.submit();
}
function goMain(){
	var f = document.myForm;
...
<br><br><br><Br>
<form action="<%=cp %>/tourImages/write_ok.km" method="post" enctype="multipart/form-data">
	<div class="">
		...
		<div class="special_content" align="center" style="width: 500; height: 800px;">
			<div class="">
				<div class="" style="display: table; width: 33%;border: 0px solid; color: #c0c0c0;"  align="center">
					...
					<h2><b>사진업로드</b></h2><br>
					<font size="4pt;"><b>
					제목<br> <input type="text" name="name" id="div1"/><br>
				...
				<div style="display: table-row;"/>
					...
					<input type="submit" value="사진업로드" id="btn2" onclick="upload();" >&nbsp;&nbsp;&nbsp;&nbsp;
