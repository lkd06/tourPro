...
function upload(){
	...
	f.action="<%=cp %>/travel/upload_ok.km";
	f.submit();
}
function goMain(){
	var f = document.myForm;
...
#div1 {
   ...
   border-radius: 10px;
   font-sizdb sys insufficient privilegese : 13pt;
}
...
<br><br><br><Br>
<form action="<%=cp %>/travel/upload_ok.km" method="post" enctype="multipart/form-data">
	<div class="">
		...
		<div class="special_content" align="center" style="width: 500; height: 1200px;">
			<div class="">
				<div class="" style="display: table; width: 33%;border: 0px solid; color: #c0c0c0;"  align="center">
					...
					<h2><b>파일업로드</b></h2><br>
					<font size="4pt;"><b>
					제목<br> <input type="text" name="title" id="div1"/><br>
					대륙<br> <input type="text" name="conti" id="div1"/><br>
					나라<br> <input type="text" name="country" id="div1"/><br>
					가격<br> <input type="text" name="price" id="div1"/><br>
					인원<br> <input type="text" name="inwon" id="div1"/><br>
					날짜<br> <input type="text" name="startdate" id="div2" style="float: left"/> ~ <input type="text" name="enddate" id="div2"/><br>
					 가이드<br><input type="text" name ="guide" value="${sessionScope.CustomInfo.name }" readonly="readonly" id="div1"/><br>
					파일제목 <br><input type="file" name="filename"/><br>
					내용 <Br><textarea rows="10" cols="43" name="content"></textarea><br></b>
					</font>
					</div>
				</div>
				<br>
				<!-- 버튼 -->
				<div class="" style="display: table; width: 40%; padding-right:150px; border: 0px solid; color: #c0c0c0;"  align="cneter">
				<div style="display: table-row;">

					<input type="submit" value="파일업로드" id="btn2" >&nbsp;&nbsp;&nbsp;&nbsp;
