		...
		<div class="special_content" align="center" style="width: 500; height: 1200px;">
			<div class="">
				<div class="" style="display: table; width: 33%;border: 0px solid; color: #c0c0c0;"  align="center">
					...
					<h2><b>장바구니</b></h2><br><br>
					<font size="4pt;"><b>
					상품번호<br> <input type="text" name="c_num" id="div1" value="${dto.c_num }"/><br><br>
					상&nbsp;품&nbsp;명<br> <input type="text" name="pw" id="div1" value="${dto.c_name }"/><br><br>
					가&nbsp;&nbsp;격<br> <input type="text" name="tel" id="div1" value="${dto.c_price }"/><br><br>
					수&nbsp;&nbsp;량<br> <input type="text" name="email" id="div1" value="${dto.c_inwon }"/><br><br></b>
					</font> 
					</div>
				...
				<div class="" style="display: table; width: 32%; padding-rigth:20px; border: 0px solid; color: #c0c0c0;"  align="left">
					<div style="display: table-row;">
						...
						<span style="display: table-cell;border: 0px solid;">
							<input type="button" value="결제하기" id="btn2" onclick="join();">
						</span>
						
						<span style="display: table-cell;border: 0px solid;">
							<input type="button" value="수정하기" id="btn2" onclick="update();">
						</span>
						 
						<span style="display: table-cell;border: 0px solid;">
							<input type="button" value="삭제하기" id="btn2" onclick="goback();"> 
						</span>
