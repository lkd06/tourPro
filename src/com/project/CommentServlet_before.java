...
import com.Trip.TripInfoDAO_before;
...
public class CommentServlet_before extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		CommentDAO_before commentdao = new CommentDAO_before(conn);
...
////////////////////////////////////////////////////////////////////////////////////		
			...
			TripInfoDAO_before tripdao = new TripInfoDAO_before(conn);
			
			List<TripInfoDTO> contilists= tripdao.getConti();
			List<TripInfoDTO> data= tripdao.getContiData(); //tripdao.getContiData();
		...
		}else if(uri.indexOf("commentwrite_title.km")!=-1) {  //후기 작성하기
			TripInfoDAO_before tripdao = new TripInfoDAO_before(conn);
			...
			CommentDTO commentdto = commentdao.getReadData(no);
			
			if(cinfo.getId() == commentdto.getId()) {
			...
			//			System.out.println(req.getParameter("sss"+"pageNum"));
